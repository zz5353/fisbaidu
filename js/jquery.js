        ...
        Expr = Sizzle.selectors = {
			...
			*/
                    ...
                    if (match[1].slice(0, 3) === "nth") {
                        ...
                        match[4] = +(match[4] ? match[5] + (match[6] || 1) : 2 * (match[3] === "even" || match[
                            3] === "odd"));
                            ...
                            jQuery.each(tuples, function (i, tuple) {
                                ...
                                deferred[tuple[1]](function () {
                                    ...
                                    if (returned && jQuery.isFunction(returned.promise)) {
                                        ...
                                        newDefer[action + "With"](this === promise ? newDefer.promise() :
                ...
                if (elem || elem === 0) {
                    ...
                    if (jQuery.type(elem) === "object") {
                        ...
                        if (!jQuery.support.tbody) {
                            ...
                            while (j--) {
                                if (jQuery.nodeName((tbody = elem.childNodes[j]), "tbody") && !tbody.childNodes
                                    .length) {
		...
		*/
        ...
        ajax: function (url, options) {
            ...
            function done(status, nativeStatusText, responses, headers) {
                ...
                if (fireGlobals) {
                    globalEventContext.trigger(isSuccess ? "ajaxSuccess" : "ajaxError", [jqXHR, s, isSuccess ?
                        success : error
                    ]);
                }
